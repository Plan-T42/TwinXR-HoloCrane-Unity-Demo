...
namespace QRTracking
{
    public class QRCodesVisualizer : MonoBehaviour
    {
        ...
        public GameObject readDTButton;
        public GameObject writeDTButton;
        public GameObject dtDashboard;
        public GameObject safetyZone;
        public GameObject saveTargetLocationButton;
            ...
            lock (pendingActions)
            {
                while (pendingActions.Count > 0)
                {
                    ...
                    if (action.type == ActionData.Type.Added)
                    {
                        ...
                        GlobalInstance.Instance.dt_id = action.qrCode.Data;
                        GameObject.Find("ReadfromServer").GetComponent<JsonReader>().GetJson();
                        readDTButton.SetActive(true);
                        writeDTButton.SetActive(true);
                        saveTargetLocationButton.SetActive(true);
                        dtDashboard.SetActive(true);
